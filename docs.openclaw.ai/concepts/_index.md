...
OpenClaw 概念文档的中英对照翻译索引。文件名按英文标题 slug 化，路径里的 `concepts/` 跟在线 URL 一致。

| 文件 | 英文标题 | 中文标题 |
|---|---|---|
| [agent-runtime.md](agent-runtime.md) | Agent runtime | Agent 运行时 |
...
| [memory-overview.md](memory-overview.md) | Memory overview | 记忆总览 |
| [message-lifecycle-refactor.md](message-lifecycle-refactor.md) | Message lifecycle refactor | 消息生命周期重构 |
